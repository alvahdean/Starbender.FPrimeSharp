...
public class GdsAppDbMigrationService : ITransientDependency
{
    public ILogger<GdsAppDbMigrationService> Logger { get; set; }

    private readonly IDataSeeder _dataSeeder;
    private readonly GdsAppDbSchemaMigrator _dbSchemaMigrator;
    private readonly ICurrentTenant _currentTenant;

    public GdsAppDbMigrationService(
        IDataSeeder dataSeeder,
        GdsAppDbSchemaMigrator dbSchemaMigrator,
        ICurrentTenant currentTenant)
    {
        ...
        Logger = NullLogger<GdsAppDbMigrationService>.Instance;
    }
    ...
    private string GetEntityFrameworkCoreProjectFolderPath()
    {
        ...
        return Path.Combine(slnDirectoryPath, "Starbender.FPrimeSharp.GdsApp");
    }
